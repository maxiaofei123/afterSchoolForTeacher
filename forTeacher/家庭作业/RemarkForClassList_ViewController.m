//
//  RemarkForClassList_ViewController.m
...
@interface RemarkForClassList_ViewController ()<UITableViewDataSource,UITableViewDelegate,UIViewPassValueDelegate>{
    NSArray * homeWorkArr;
...
@implementation RemarkForClassList_ViewController
...
-(void)allRemark
{
    ...
    remark.markType = @"forClass";
    remark.classId = self.classId;
...
-(void)requestHomeworkId
{
    ...
    [manager GET:[NSString stringWithFormat:@"http://114.215.125.31/api/v1/home_works?school_class_id=%@&work_paper_id=%@",self.classId,self.workId ]parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject){
